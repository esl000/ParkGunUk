// BasicEngine.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
...
void SetQuit(bool);
static void StartRenderThread(LPVOID pData);
void SetResolution(RECT& rc);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_BASICENGINE));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_BASICENGINE);
...
void StartRenderThread(LPVOID pData)
{
	while (true)
	{
		pMain->Render();
